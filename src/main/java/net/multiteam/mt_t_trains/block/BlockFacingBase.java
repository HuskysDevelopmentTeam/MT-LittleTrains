...
public class BlockFacingBase extends BlockFacing {

    protected static final AxisAlignedBB CARPET_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.D, 0.065D, 1.0D);

    public boolean isPlate;

    public BlockFacingBase(String name, boolean isPlate) {
        super(Material.WOOD, MOD_ID, name);
        this.isPlate = isPlate;
        setCreativeTab(MTTTrains.TERRAIN_CREATIVE_TAB);
    }

    public BlockFacingBase(String name) {
        super(Material.WOOD, MOD_ID, name);
        this.isPlate = false;
        setCreativeTab(MTTTrains.TERRAIN_CREATIVE_TAB);
    }
