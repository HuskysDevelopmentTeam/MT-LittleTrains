...
public abstract class EntityColoredTrainPart extends EntityTrainPart {
    protected static final DataParameter<Integer> COLOR = EntityDataManager.createKey(EntityColoredTrainPart.class, DataSerializers.VARINT);

    protected EntityColoredTrainPart(World worldIn) {
        super(worldIn);
    }
