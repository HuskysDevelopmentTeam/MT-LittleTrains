...
public abstract class EntityTrain extends Entity {
    ...
    private static final DataParameter<Integer> TURN_DIRECTION = EntityDataManager.createKey(EntityTrain.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> TURN_SENSITIVITY = EntityDataManager.createKey(EntityTrain.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> MAX_TURN_ANGLE = EntityDataManager.createKey(EntityTrain.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> ACCELERATION_DIRECTION = EntityDataManager.createKey(EntityTrain.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.createKey(EntityTrain.class, DataSerializers.VARINT);
    private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(EntityTrain.class, DataSerializers.FLOAT);
    private static final DataParameter<Integer> ENGINE_TYPE = EntityDataManager.createKey(EntityTrain.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> HORN = EntityDataManager.createKey(EntityTrain.class, DataSerializers.BOOLEAN);
    ...
    protected EntityTrain(World worldIn) {
        super(worldIn);
        this.setSize(1F, 1F);
        this.stepHeight = 1.0F;
    }

    public EntityTrain(World worldIn, double posX, double posY, double posZ) {
        this(worldIn);
    ...
    private void onClientUpdate() {
        ...
        if (entity != null && entity.equals(Minecraft.getMinecraft().player)) {
            ...
            /*boolean horn = CProxy.KEY_HORN.isKeyDown();
            this.setHorn(horn);
