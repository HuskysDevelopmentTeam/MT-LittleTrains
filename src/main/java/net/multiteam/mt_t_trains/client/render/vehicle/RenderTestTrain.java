package net.multiteam.mt_t_trains.client.render.vehicle;
...
import net.multiteam.mt_t_trains.client.render.RenderTrainPart;
import net.multiteam.mt_t_trains.client.render.Wheel;
import net.multiteam.mt_t_trains.entity.vehicle.EntityTestTrain;

import javax.annotation.Nullable;

public class RenderTestTrain extends RenderTrainPart<EntityTestTrain> {

    public RenderTestTrain(RenderManager renderManager) {
        super(renderManager);
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityTestTrain entity)
    {
        return null;
    }

    @Override
    public void doRender(EntityTestTrain entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
