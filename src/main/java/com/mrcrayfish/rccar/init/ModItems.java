...
public class ModItems 
{
	...
	{
		ForgeRegistries.ITEMS.register(controller);
		ForgeRegistries.ITEMS.register(car);
		ForgeRegistries.ITEMS.register(wheel);
		ForgeRegistries.ITEMS.register(wrench);
		ForgeRegistries.ITEMS.register(car_base);
		
		ModCases.CASES.forEach(c -> ForgeRegistries.ITEMS.register(c.item));
	}
