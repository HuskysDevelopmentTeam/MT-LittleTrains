...
{
	public static final Predicate<Item> ATTACHMENT_PREDICATE = input -> input instanceof IAttachment;
	...
	public void render(int mouseX, int mouseY)
	{
    	...
    	int startX = (gui.width - this.X_SIZE) / 2;
 		...
 		gui.drawString(gui.mc.fontRenderer, "Pick a module to attach", startX + 7, startY + 5, Color.WHITE.getRGB());
